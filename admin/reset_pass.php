                ...
                <div class="login-style">
                    <div class="login-coloum pdn-btm">
                        ...
                        if ($_GET['key'] && $_GET['reset']) {
                            ...
                            $select = mysqli_query($conn, "SELECT email,password FROM pegawai WHERE email='$email' AND md5(password)='$pass'");
                        ...
                        if (isset($_POST['submit_password'])) {
                            ...
                            $select = mysqli_query($conn, "UPDATE pegawai SET password='" . md5($pass) . "' WHERE email='$email'");
                            if ($select) {
