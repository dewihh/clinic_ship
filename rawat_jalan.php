...
<head>
    ...
    @$nama = $_POST['nama'];
    $cek = mysqli_query($conn, "SELECT * FROM table_the_iot_projects WHERE name='$nama' OR id='$nama'");
    ...
    if (isset($_POST['jalan2'])) {
        ...
        mysqli_query($conn, "UPDATE table_the_iot_projects SET adress='$alam', age='$tgl', berat='$berat', tinggi='$tinggi' WHERE name='$namamu'");
    }
    ...
    if (isset($_POST['print'])) {
        ...
        $tolologi2 = mysqli_query($conn, "SELECT * FROM table_the_iot_projects WHERE id='$idpasien'");
